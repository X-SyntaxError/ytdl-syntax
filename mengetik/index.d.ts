declare module 'ytdl-core' {
  ...
  namespace ytdl {
    ...
    antarmuka terkaitVideo {
      ...
      penulis: Penulis | 'rangkaian'; // untuk menghapus bagian `string` nanti

      asam?: string; // untuk menghapus nanti

      author_thumbnail?: string; // untuk menghapus nanti

      short_view_count_text?: string;

      view_count?: string;

      length_seconds?: angka;

      video_thumbnail?: string; // untuk menghapus nanti
    ...
    fungsi getBasicInfo(url: string, opsi?: getInfoOptions): Janji<videoInfo>;
